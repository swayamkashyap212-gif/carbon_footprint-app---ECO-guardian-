...
copy /Y "android\app\build\outputs\apk\release\app-release.apk" "EcoGuardian-v20.0.0-release.apk"
if %errorlevel% neq 0 (
    echo [WARN] Could not copy APK. It may still be at: android\app\build\outputs\apk\release\app-release.apk
) else (
    echo APK copied to: EcoGuardian-v20.0.0-release.apk
)

echo [4/4] Build complete!
echo.
echo To install via USB: adb install -r EcoGuardian-v20.0.0-release.apk
